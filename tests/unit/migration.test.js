...
describe('migration.js', () => {
  describe('migrateData() - Full Migration Chain', () => {
    it('should migrate v1 data to v11', () => {
    ...
    it('should migrate v6 data to v11', () => {
    ...
    it('should migrate v7 data to v11 adding sutaWageBase and converting dates', () => {
      const v7Data = {
        version: 7,
    ...
    it('should migrate v8 data to v11 converting date formats', () => {
      const v8Data = {
        version: 8,
    ...
    it('should migrate v9 data to v11 adding quarterly earnings settings', () => {
      const v9Data = {
        version: 9,
    ...
    it('should migrate v10 data to v11 adding auditLog', () => {
      const v10Data = {
        version: 10,
    ...
    it('should not modify data already at v11', () => {
      const v11Data = {
        version: 11,
        settings: { companyName: 'Test', quarterlyEarningsTarget: 2000, minimumWeeklyHours: 25 },
        employees: [],
